package net.zerotodev.api.reactive;
...
import net.zerotodev.api.reactive.config.CustomException;
...
public class FluxAndMonoTest {
    ...
    @Test @DisplayName("Flux range() Sample")
    void rangeTest(){
    ...
    @Test @DisplayName("Flux fromArray() Sample")
    void fromArrayTest(){
    ...
    @Test @DisplayName("Flux fromStream() Sample")
    void fromStreamTest(){
        List<String> list = new ArrayList<>();
    ...
    @Test @DisplayName("Flux generator() Sample")
    void generatorTest(){
    ...
    @Test @DisplayName("Mono empty() Sample")
    void monoEmptyTest(){
